...
INSERT INTO library.book (id, title, author, release_time, genre, lending_period, location, quantity) VALUES (DEFAULT, 'Clean Code', 'Robert C. Martin', '2008-08-01', 'Education', 7, '1 floor', 5);
INSERT INTO library.book (id, title, author, release_time, genre, lending_period, location, quantity) VALUES (DEFAULT, 'Aabits', 'Eno Raud', '2022-12-22', 'Education', 14, '1 floor', 23);
INSERT INTO library.book (id, title, author, release_time, genre, lending_period, location, quantity) VALUES (DEFAULT, 'T6de ja 6igus', 'A.H.Tammsaare', '1856-07-09', 'Fiction', 7, '2 floor', 14);
